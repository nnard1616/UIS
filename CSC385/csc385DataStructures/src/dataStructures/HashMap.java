...
public class HashMap implements Map {
     ...
     */
    /**
     * create a new, empty HashMap: 1)	the default set of prime table sizes is
     * used 2)	uses DefaultHashFunction for computing hashes 3)	default load
     * factor is used
     */
    public HashMap() {
    ...
    /**
     * create a new, empty HashMap: 1)	the default set of prime table sizes is
     * used 2)	uses the specified hash function for computing hashes 3)	default
     * load factor is used
     *
    ...
    /**
     * create a new, empty HashMap: 1)	the specified set of prime table sizes is
     * used 2)	uses the specified hash function for computing hashes 3)	uses the
     ...
     *
     * returns true if the remove was successful returns false for unsuccessful
     * removal, including case where key has not been mapped to an existing item
     */
    ...
    /**
     * empty this HashMap the empty HashMap will be reset to its minimum
     * capacity
     */
    public void clear() {
    ...
    /**
     * return true if this HashMap contains 0 items, or false if the HashMap
    ...
    /**
     * return an Iterator for this HashMap that begins at the first entry in the
     * HashMap
     *
    ...
    /**
     * return a MapIterator for this HashMap that begins at the first entry in
     * the HashMap
     *
     ...
     *
     * This class allows one-way traversal of the entries in a HashMap, but does
     * not provide a mechanism for adding or removing entries
     */
    protected class HashMapIterator implements MapIterator {
         ...
         * HashMap
         *
         * if HashMap is empty, this HashMapIterator will still be created, but
        ...
        /**
         * return whether there is a next item to traverse return true if yes,
         * false otherwise
         */
