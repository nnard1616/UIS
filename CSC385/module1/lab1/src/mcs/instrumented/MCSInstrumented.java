...
public class MCSInstrumented
{
	...
	public MCSInstrumented()
	{
		...
		statementsCubic[4] =	"(i loop jump) for ( ; ; )";
		statementsCubic[5] =	"        if (i < a.length)";
		statementsCubic[6] =	"               int j = i;";
		statementsCubic[7] =	"(j loop jump) for ( ; ; )";
		statementsCubic[8] =	"        if (j < a.length)";
		statementsCubic[9] =	"         int thisSum = 0;";
		statementsCubic[10] =	"               int k = i;";
		statementsCubic[11] =	"(k loop jump) for ( ; ; )";
		statementsCubic[12] =	"              if (k <= j)";
		statementsCubic[13] =	"         thisSum += a[k];";
		statementsCubic[14] =	"                     k++;";
		statementsCubic[15] =	"    if (thisSum > maxSum)";
		statementsCubic[16] =	"        maxSum = thisSum;";
		statementsCubic[17] =	"            seqStart = i;";
		statementsCubic[18] =	"              seqEnd = j;";
		...
		statementsLinear[6] =	"(j loop jump) for ( ; ; )";
	...
	public void analyzeMCSCubic(int[] sequence)
	{
		...
		System.out.println("Analysis of Cubic MCS Algorithm:\n");
		System.out.println("N = " + sequence.length);
		System.out.println("maxSum = " + mcs);
		System.out.println("\n           Statements    # of Executions");
	...
	public void analyzeMCSQuadratic(int[] sequence)
	{
		...
		System.out.println("Analysis of Quadratic MCS Algorithm:\n");
		System.out.println("N = " + sequence.length);
		System.out.println("maxSum = " + mcs);
		System.out.println("\n           Statements    # of Executions");
	...
	public void analyzeMCSLinear(int[] sequence)
	{
		...
		System.out.println("Analysis of Linear MCS Algorithm:\n");
		System.out.println("N = " + sequence.length);
		System.out.println("maxSum = " + mcs);
		System.out.println("\n           Statements    # of Executions");
